...
- **Build:** `gdlint` 0 errores · GUT 218/218 tests (correr SIEMPRE vía `./tools/run_tests.sh`, no invocar GUT directo — ver sección "Desbloqueo secuencial..." en `idea-base.md`) · `--export-debug Android` genera APK válido · `deploy-playstore.yml` probado (subió a Play Store Internal Testing).
